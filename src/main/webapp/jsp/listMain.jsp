...
<!--card-->
   .card {
        position: relative;
        transition: all 0.3s ease; /* 트랜지션을 추가하여 애니메이션 효과 */
    }

    /* 호버 시 외곽선과 그림자 효과 */
    .card:hover {
        border: 2px solid #ccc; /* 외곽선 색상 */
...
<body>
 ...
 <%
    ...
    <a href="information.jsp?num=<%=rs.getInt("num")%>" style="position: absolute; top: 0; bottom: 0; right:0; left: 0;" class="border-button">
    </a>
   ...
   <fmt:formatNumber value="<%=price%>" pattern="#,###"/>원
        ...
        <a href="information.jsp?num=<%=rs.getInt("num")%>" class="btn-gradient green mini" role="button">
